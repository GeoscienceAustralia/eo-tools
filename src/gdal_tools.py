...
class ImageShape(object):
    ...
    def RasterCellSize(self):
        ...
        """
        assert self._ImageShape__pix_sz[0] == abs(
            self._ImageShape__pix_sz[1]), "Cannot use method ImageShape.CellSize when X and Y cell sizes are different."
...
def warp(
        ...
        buffer_widths,
        output_format,
        resammple_method="bilinear",
        bounds_getter=default_bounds_getter):
    """
